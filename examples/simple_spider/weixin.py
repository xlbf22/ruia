...
class WxPay(object):
    ...
    def swiping_card_payment(self, **data):
        ...
        :return: 统一下单生成结果
        """
        url = "https://api.mch.weixin.qq.com/pay/micropay".encode()
        ...
        # raw = self.fetch(url, data)
        raw = self.fetch_with_ssl(url, data, api_client_cert_path=r'C:\Users\zhangqian\Desktop\cert\apiclient_cert.pem',
                                  api_client_key_path=r'C:\Users\zhangqian\Desktop\cert\apiclient_key.pem')
...
if __name__ == '__main__':
    WxPay(wx_app_id='wx1e165b1df6da069f', wx_mch_id='1231458202', wx_mch_key='x8BYH411mcJ9q5Cy2WHoA2e8C8YNMf5N', wx_notify_url='').refund()
